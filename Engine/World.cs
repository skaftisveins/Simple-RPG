...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateItems()
        {
            ...
            _items.Add(new Weapon(ITEM_ID_LEATHER_AXE, "Leather axe", "Leather axes", 2, 7, 3));
        ...
        private static void PopulateMonsters()
        {
            ...
            rat.LootTable.Add(new LootItem(ItemByID(ITEM_ID_LEATHER_AXE), 75, false));
        ...
        private static void PopulateLocations()
        {
            ...
            Vendor harryTheRatCatcher = new Vendor("Harry the Rat-Catcher");

            harryTheRatCatcher.AddItemToInventory(ItemByID(ITEM_ID_PIECE_OF_FUR), 5);
            harryTheRatCatcher.AddItemToInventory(ItemByID(ITEM_ID_RAT_TAIL), 3);

            townSquare.VendorWorkingHere = harryTheRatCatcher;
            ...
            alchemistsGarden.AddMonster(MONSTER_ID_SNAKE, 80);
            ...
            farmersField.AddMonster(MONSTER_ID_RAT, 80);
